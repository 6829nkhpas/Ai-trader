...
export function registerTradeRoutes(app) {
  ...
  // In a real microservice, requireVerified would be exported to an API Gateway or imported in orders-service.
  app.post('/api/v1/orders', { preHandler: [authGuard, requireVerified] }, async (req, reply) => {
