...
## Corpus Check
- 268 files · ~340,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5445 nodes · 12821 edges · 287 communities (268 shown, 19 thin omitted)
...
Cohesion: 0.08
Nodes (30): fetch_candles_for_symbol(), RadarAlert, spawn_radar_worker(), current_count(), download_csv(), ensure_schema(), is_stale(), parse_and_persist() (+22 more)
...
Cohesion: 0.10
Nodes (11): connect_ticker(), Args, get_kite_credentials(), init_producer(), main(), now_ms(), PriceEngine, SubscribeCmd (+3 more)
...
Cohesion: 0.09
Nodes (19): BILLING_CATALOG, BillingController, handlePolarWebhook(), verifySignature(), requireActiveSubscription(), BillingRepository, findUserById(), registerTradeRoutes() (+11 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (27): registerErrorHandler(), registerAuthRoutes(), registerKycRoutes(), registerStocksRoutes(), BillingSyncEngine, getClient(), isArticleProcessed(), markArticleProcessed() (+19 more)
...
Cohesion: 0.13
Nodes (23): handleGetProfile(), handleGetUploadUrl(), handleLivenessCheck(), handleUpsertProfile(), handleVerifyPan(), handleKycVendorWebhook(), decryptSymmetric(), encryptSymmetric() (+15 more)
...
Cohesion: 0.20
Nodes (13): get_kite_credentials(), historical_handler(), HistoricalParams, InstrumentCache, instruments_search(), InstrumentSearchParams, KiteApiState, parse_csv_line() (+5 more)
...
Cohesion: 0.22
Nodes (19): ACCESS_COOKIE_OPTS, COOKIE_OPTS, handleGenerateMfa(), handleGoogleLogin(), handleHealth(), handleLogin(), handleLogout(), handleRefresh() (+11 more)
...
Cohesion: 0.07
Nodes (24): Home(), AuthOverlay(), BrokerConnectCard(), MarginData, OrderItem, PositionItem, PositionsPayload, useMargins() (+16 more)
...
Cohesion: 0.13
Nodes (19): ARGON2_OPTIONS, hashPassword(), start, verifyPassword(), AuthenticationError, DuplicateEmailError, NotFoundError, PasswordComplexityError (+11 more)

### Community 174 - "Community 174"
Cohesion: 0.06
Nodes (39): AlphaPredictiveChart.tsx, DeepSeek v4 Pro via NVIDIA NIM, Technical Analysis Agent, DeepQuantPanel.tsx, TechSignal Protobuf Contract, AiExecutionPlanView(), AiExecutionPlanViewProps, AiPlanShape (+31 more)
...
- **Why does `run()` connect `Community 1` to `Community 6`, `Community 7`, `Community 173`, `Community 154`, `Community 27`, `Community 93`?**
