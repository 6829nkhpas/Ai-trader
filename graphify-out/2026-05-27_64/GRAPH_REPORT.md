...
## Corpus Check
- 244 files · ~323,060 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5289 nodes · 12513 edges · 289 communities (272 shown, 17 thin omitted)
...
Cohesion: 0.11
Nodes (12): current_count(), download_csv(), ensure_schema(), is_stale(), parse_and_persist(), parse_csv_line(), spawn(), run_consumer() (+4 more)
...
Cohesion: 0.03
Nodes (151): ac(), addItem(), Am(), Ao(), apiKey(), append(), applyPendingMigrations(), As() (+143 more)
...
Cohesion: 0.07
Nodes (39): ap(), ci(), en(), ep(), Es(), fromContent(), He(), ic() (+31 more)
...
Cohesion: 0.09
Nodes (29): Bd(), cp(), da(), Fi(), Gd(), get(), getAllBatchQueryCallbacks(), getAllClientExtensions() (+21 more)
...
Cohesion: 0.11
Nodes (30): _a(), Br(), ct(), Fu(), ga(), ii(), In(), ju() (+22 more)
...
Cohesion: 0.12
Nodes (25): addMarginSymbol(), afterNextNewline(), ea(), getCurrentLineLength(), hl(), indent(), indentedCurrentLine(), lc() (+17 more)
...
## Knowledge Gaps
- **1075 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1070 more)
...
- **Why does `run()` connect `Community 50` to `Community 288`, `Community 1`, `Community 7`, `Community 173`, `Community 154`, `Community 27`, `Community 93`?**
