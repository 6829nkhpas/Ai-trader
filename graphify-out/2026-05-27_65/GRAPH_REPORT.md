...
## Corpus Check
- 244 files · ~323,064 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5291 nodes · 12515 edges · 284 communities (268 shown, 16 thin omitted)
...
## Communities (284 total, 16 thin omitted)
...
Cohesion: 0.06
Nodes (26): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, AuthOverlay(), BrokerConnectCard(), OAuthCompleteInner(), OAuthCompletePage() (+18 more)
...
## Knowledge Gaps
- **1077 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1072 more)
