...
## Corpus Check
- 245 files · ~323,133 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5293 nodes · 12516 edges · 285 communities (268 shown, 17 thin omitted)
...
Cohesion: 0.17
Nodes (17): deploy_ai_sentinel(), fetch_google_news_rss_for_context(), fetch_macro_context(), fetch_news_context(), get_latest_tick_time(), load_candles_from_db(), ManualTradeInfo, parse_agent_response() (+9 more)
...
## Knowledge Gaps
- **1078 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1073 more)
