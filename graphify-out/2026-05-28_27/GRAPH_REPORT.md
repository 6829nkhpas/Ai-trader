...
## Corpus Check
- 269 files · ~342,469 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5452 nodes · 12838 edges · 297 communities (276 shown, 21 thin omitted)
...
## Communities (297 total, 21 thin omitted)
...
Cohesion: 0.19
Nodes (14): Aggregator Decision Engine, Alpha Terminal (OHLC Engine), Kafka Topic: market.ohlc.10m, Kafka Topic: market.ticks, Redpanda (Kafka-compatible Broker), AggregatedDecision Protobuf Contract, OHLCCandle Protobuf Contract, Aggregator Docker Service (+6 more)
...
Cohesion: 0.08
Nodes (36): LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock(), SentimentBlockProps, sentimentImpactColor() (+28 more)
...
Cohesion: 0.25
Nodes (9): AlphaPredictiveChart.tsx, AlphaPredictiveChart.tsx Chart Render, IndicatorState Struct (16 indicators), Seasoned Historian V3 Prompt Core, VWEPR Curvature Regression Model, Bollinger Bands Indicator, EMA 21 Indicator, EMA 9 Indicator (+1 more)
...
## Knowledge Gaps
- **1066 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1061 more)
...
- **Why does `useHistoricalData.ts Hook` connect `Community 9` to `Community 17`, `Community 44`, `Community 69`, `Community 22`?**
