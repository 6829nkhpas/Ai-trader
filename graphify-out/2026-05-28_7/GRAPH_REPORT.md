...
## Corpus Check
- 264 files · ~333,519 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5407 nodes · 12687 edges · 295 communities (277 shown, 18 thin omitted)
...
Cohesion: 0.12
Nodes (21): lookup_instrument_token(), resolve_token_blocking(), fetchInstruments(), GET(), SearchInstrument, GET(), get_kite_credentials(), historical_handler() (+13 more)
...
Cohesion: 0.13
Nodes (29): build_request_body(), build_system_prompt(), generate_deep_quant_plan_with_url(), tauri::AppHandle, AiExecutionPlan, call_deepseek(), ChatChoice, ChatMessage (+21 more)
...
Cohesion: 0.08
Nodes (35): LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock(), SentimentBlockProps, sentimentImpactColor() (+27 more)
...
Cohesion: 0.09
Nodes (21): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, AuthOverlay(), BrokerConnectCard(), OAuthCompletePage(), DashboardPage() (+13 more)
...
Cohesion: 0.12
Nodes (8): SqlTrade, UserProfileModal(), UserProfileModalProps, BrokerTabProps, ProfileTabProps, SubscriptionTabProps, SqlTrade, TransactionsTabProps
...
Cohesion: 0.14
Nodes (6): AuthController, authService, AuthenticatedRequest, authenticateJWT(), controller, router

### Community 282 - "Community 282"
Cohesion: 0.25
Nodes (5): PaymentController, paymentService, controller, phonepeController, router
...
Cohesion: 0.25
Nodes (5): app, AuthenticatedRequest, currentPeriodEnd, token, userId
