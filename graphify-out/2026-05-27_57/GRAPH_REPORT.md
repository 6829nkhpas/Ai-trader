...
## Corpus Check
- 241 files · ~321,004 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5275 nodes · 12489 edges · 283 communities (267 shown, 16 thin omitted)
...
## Communities (283 total, 16 thin omitted)
...
Cohesion: 0.12
Nodes (13): fetch_candles_for_symbol(), RadarAlert, spawn_radar_worker(), current_count(), download_csv(), ensure_schema(), is_stale(), parse_and_persist() (+5 more)
...
Cohesion: 0.15
Nodes (12): BILLING_CATALOG, handlePolarWebhook(), verifySignature(), requireActiveSubscription(), BillingRepository, config, __dirname, required (+4 more)
...
Cohesion: 0.11
Nodes (25): handleGetProfile(), handleGetUploadUrl(), handleLivenessCheck(), handleUpsertProfile(), handleVerifyPan(), handleKycVendorWebhook(), decryptSymmetric(), encryptSymmetric() (+17 more)

### Community 25 - "Community 25"
Cohesion: 0.10
Nodes (26): AgentChoice, AgentMessage, AgentMessagePayload, AgentResponse, AgentToolCall, AppHandleExt, ChatChoice, ChatMessage (+18 more)
...
Cohesion: 0.07
Nodes (45): VerificationFormProps, LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock(), SentimentBlockProps (+37 more)
...
Cohesion: 0.06
Nodes (24): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, handleEmailBlur(), handlePassBlur(), validateEmail(), validatePassword() (+16 more)
...
- **Why does `useHistoricalData.ts Hook` connect `Community 9` to `Community 17`, `Community 50`, `Community 44`, `Community 22`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 70` to `Community 1`, `Community 7`, `Community 173`, `Community 89`, `Community 154`, `Community 27`, `Community 93`?**
