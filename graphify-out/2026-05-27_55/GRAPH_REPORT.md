...
## Corpus Check
- 204 files · ~218,163 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2542 nodes · 4398 edges · 210 communities (195 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 117 edges (avg confidence: 0.83)
...
Cohesion: 0.05
Nodes (48): ConsensusEngine (Tauri Quant), Quant Radar Background Scanner, AiExecutionPlanView(), AiExecutionPlanViewProps, AiPlanShape, convictionColor(), convictionIcon(), convictionLabel() (+40 more)
...
Cohesion: 0.10
Nodes (15): BILLING_CATALOG, handlePolarWebhook(), verifySignature(), handleKycVendorWebhook(), requireActiveSubscription(), BillingRepository, registerTradeRoutes(), registerWebhookRoutes() (+7 more)
...
Cohesion: 0.08
Nodes (30): Alpha Suite V2 — Production Setup Guide, Architecture Reference, CMake Not Found (Local Dev Only), code:bash (cp .env.example .env), code:block10 (ERROR: Kite WS auth failed — 403 Forbidden), code:block11 (ERROR: DeepSeek API failure: NVIDIA NIM request timeout), code:block12 (error: failed to run custom build command for `rdkafka-sys`), code:env (# ── Zerodha Kite Connect ──────────────────────────────────) (+22 more)
...
Cohesion: 0.10
Nodes (35): ACCESS_COOKIE_OPTS, COOKIE_OPTS, handleGenerateMfa(), handleGoogleLogin(), handleHealth(), handleLogin(), handleLogout(), handleRefresh() (+27 more)
...
Cohesion: 0.07
Nodes (33): TradingChart(), TradingChartProps, AgentStatusPanel(), AIPanel(), clampScore(), LiveFeedPanel(), getLatencyColor(), NetworkMetrics() (+25 more)
...
Cohesion: 0.15
Nodes (19): handleGetProfile(), handleGetUploadUrl(), handleLivenessCheck(), handleUpsertProfile(), handleVerifyPan(), verifyPan(), requireVerified(), mfaGuard() (+11 more)
...
Cohesion: 0.12
Nodes (20): lookup_instrument_token(), resolve_token_blocking(), fetchInstruments(), GET(), SearchInstrument, GET(), historical_handler(), HistoricalParams (+12 more)
...
Cohesion: 0.08
Nodes (23): Active Phase, All Files (Cumulative), All Files (Cumulative — SP43-45 additions), code:block10 (cargo check --no-default-features  (agents/technical)), code:block11 (cargo check --no-default-features  (agents/technical)), code:block12 (cargo check --no-default-features  (sqlx 0.8.6)), code:block13 (ingestion/), code:block24 (aggregator/) (+15 more)
...
Cohesion: 0.18
Nodes (9): DeepQuantPanel.tsx, LOADING_PHASES, LoadingStateProps, VerificationForm(), VerificationFormProps, convictionIcon(), convictionLabel(), LOADING_PHASES (+1 more)
...
Cohesion: 0.05
Nodes (23): inter, metadata, AuthLayout(), handleEmailBlur(), handlePassBlur(), validateEmail(), validatePassword(), isSection() (+15 more)

### Community 47 - "Community 47"
Cohesion: 0.09
Nodes (29): LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock(), SentimentBlockProps, sentimentImpactColor() (+21 more)
...
Cohesion: 0.19
Nodes (18): Alpha Terminal (OHLC Engine), DeepSeek v4 Pro via NVIDIA NIM, Kafka Topic: market.ohlc.10m, MarketInsight Protobuf, Predictive Agent (Ghost Line), Quant-RAG Agent (DeepSeek), Kafka Topic: signals.insights, Kafka Topic: signals.predictive (+10 more)
...
Cohesion: 0.21
Nodes (10): authRoot, __dirname, loadPublicKey(), privateKeyPath, publicKeyPath, verifyAccessToken(), authGuard(), blacklistJti() (+2 more)
...
Cohesion: 0.33
Nodes (6): 31 — `agents/sentiment/src/cache.js` — NEW, 32 — `agents/sentiment/src/analyzer.js` — NEW, 33 — `agents/sentiment/src/index.js` — REPLACED (testable integration flow), All Files (Cumulative — SP28-33 additions), code:block16 (fetchLatestNews("TATA")), Subphases 31-33 (Directive — 2026-04-23T03:10:14+05:30): Redis Cache + Claude Analyzer + Integration ✅ COMPLETE THIS SESSION
...
Cohesion: 0.29
Nodes (12): analyze_sentiment_via_llm(), fetch_google_news_rss(), fetch_news_headlines(), fetch_symbol_sentiment(), first_non_empty(), LlmSentimentResponse, mock_sentiment(), resolve_llm_endpoint() (+4 more)
...
Cohesion: 0.29
Nodes (7): code:env (# ── database configuration ───────────────────────────────), code:bash (cd agents/deep-quant-loop), code:bash (cd frontend/src-tauri), code:bash (cd frontend), Dev Launch Pipeline, 🛠️ Developer Setup & Deployment, Environment Configurations
...
Cohesion: 0.10
Nodes (19): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, SystemConsole.tsx, OAuthCompletePage(), StatusDot(), StatusLabel() (+11 more)
...
Cohesion: 0.22
Nodes (9): Aggregator Decision Engine, Kafka Topic: market.ticks, Redpanda (Kafka-compatible Broker), AggregatedDecision Protobuf Contract, Aggregator Docker Service, Alpha Terminal Docker Service, Predictive Agent Docker Service, Quant-RAG Agent Docker Service (+1 more)
...
Cohesion: 0.18
Nodes (12): AlphaPredictiveChart.tsx, ChartTimeframe State Engine, Predictive Ghost Line Overlay, AlphaPredictiveChart.tsx Chart Render, IndicatorState Struct (16 indicators), VWEPR Curvature Regression Model, agents/predictive/math.rs OLS Engine, Bollinger Bands Indicator (+4 more)
...
Cohesion: 0.46
Nodes (7): ConsensusBoard(), Props, stateColor(), stateIcon(), trendBg(), trendColor(), trendGlow()

## Knowledge Gaps
- **822 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+817 more)
...
- **Why does `resolve_instrument_token()` connect `Community 9` to `Community 41`, `Community 26`, `Community 27`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `useHistoricalData.ts Hook` connect `Community 9` to `Community 17`, `Community 19`, `Community 44`, `Community 22`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 70` to `Community 1`, `Community 7`, `Community 14`, `Community 182`, `Community 89`, `Community 154`, `Community 27`, `Community 93`?**
