...
## Corpus Check
- 258 files · ~324,392 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5352 nodes · 12598 edges · 294 communities (277 shown, 17 thin omitted)
...
Cohesion: 0.10
Nodes (14): fetch_candles_for_symbol(), RadarAlert, spawn_radar_worker(), current_count(), download_csv(), ensure_schema(), is_stale(), parse_and_persist() (+6 more)
...
Cohesion: 0.08
Nodes (18): rsi_warm_up_gating(), update_rsi(), update_vwap(), vwap_basic_calculation(), vwap_no_volume_returns_none(), generate_access_token(), KiteSessionData, KiteSessionResponse (+10 more)
...
Cohesion: 0.11
Nodes (16): BILLING_CATALOG, handlePolarWebhook(), verifySignature(), requireActiveSubscription(), BillingRepository, registerTradeRoutes(), config, __dirname (+8 more)
...
Cohesion: 0.16
Nodes (18): handleGetProfile(), handleGetUploadUrl(), handleLivenessCheck(), handleUpsertProfile(), handleVerifyPan(), verifyPan(), requireVerified(), mfaGuard() (+10 more)
...
Cohesion: 0.15
Nodes (13): DeepSeek v4 Pro via NVIDIA NIM, DeepQuantPanel.tsx, LOADING_PHASES, LoadingStateProps, VerificationForm(), VerificationFormProps, convictionIcon(), convictionLabel() (+5 more)
...
Cohesion: 0.07
Nodes (45): lookup_instrument_token(), resolve_token_blocking(), LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock() (+37 more)
...
Cohesion: 0.19
Nodes (11): authRoot, __dirname, loadPrivateKey(), loadPublicKey(), privateKeyPath, publicKeyPath, verifyAccessToken(), authGuard() (+3 more)
...
Cohesion: 0.24
Nodes (6): BillingController, findUserById(), registerBillingRoutes(), BillingService, body, prisma
...
Cohesion: 0.14
Nodes (19): AlphaPredictiveChart.tsx, Technical Analysis Agent, TechSignal Protobuf Contract, AlphaPredictiveChart.tsx Chart Render, IndicatorState Struct (16 indicators), Seasoned Historian V3 Prompt Core, VWEPR Curvature Regression Model, indicators.rs (RSI + VWAP) (+11 more)
...
Cohesion: 0.31
Nodes (14): ACCESS_COOKIE_OPTS, COOKIE_OPTS, handleGenerateMfa(), handleGoogleLogin(), handleHealth(), handleLogin(), handleLogout(), handleRefresh() (+6 more)
...
Cohesion: 0.10
Nodes (15): handleKycVendorWebhook(), AuthenticationError, DuplicateEmailError, NotFoundError, PasswordComplexityError, TokenReuseError, registerErrorHandler(), registerAuthRoutes() (+7 more)
...
- **Why does `resolve_instrument_token()` connect `Community 9` to `Community 41`, `Community 27`, `Community 245`, `Community 47`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 50` to `Community 1`, `Community 6`, `Community 7`, `Community 173`, `Community 154`, `Community 27`, `Community 93`, `Community 287`?**
