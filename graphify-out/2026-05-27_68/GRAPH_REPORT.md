...
## Corpus Check
- 249 files · ~324,403 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5321 nodes · 12553 edges · 287 communities (268 shown, 19 thin omitted)
...
## Knowledge Gaps
- **1080 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1075 more)
