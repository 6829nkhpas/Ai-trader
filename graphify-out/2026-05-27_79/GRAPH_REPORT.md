...
## Corpus Check
- 258 files · ~324,904 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5356 nodes · 12606 edges · 294 communities (277 shown, 17 thin omitted)
...
## Communities (294 total, 17 thin omitted)
...
Cohesion: 0.09
Nodes (13): generate_access_token(), KiteSessionData, KiteSessionResponse, connect_ticker(), Args, init_producer(), main(), now_ms() (+5 more)
...
Cohesion: 0.11
Nodes (16): BILLING_CATALOG, BillingController, handlePolarWebhook(), verifySignature(), handleKycVendorWebhook(), requireActiveSubscription(), BillingRepository, registerWebhookRoutes() (+8 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (28): registerErrorHandler(), registerStocksRoutes(), BillingSyncEngine, analyzeSentiment(), getClient(), getClient(), isArticleProcessed(), markArticleProcessed() (+20 more)
...
Cohesion: 0.05
Nodes (60): Aggregator Decision Engine, Alpha Terminal (OHLC Engine), ChartTimeframe State Engine, Glass-Box Trading Frontend, Predictive Ghost Line Overlay, QuestDB historical_candles Table, history_loader.rs Service, Ingestion Service (+52 more)
...
Cohesion: 0.06
Nodes (40): SystemConsole.tsx, StatusDot(), StatusLabel(), SystemConsole(), SystemLog, TradingChart(), TradingChartProps, AgentStatusPanel() (+32 more)
...
Cohesion: 0.14
Nodes (20): handleGetProfile(), handleGetUploadUrl(), handleLivenessCheck(), handleUpsertProfile(), handleVerifyPan(), verifyPan(), requireVerified(), mfaGuard() (+12 more)
...
Cohesion: 0.14
Nodes (16): fetchInstruments(), GET(), GET(), historical_handler(), HistoricalParams, InstrumentCache, instruments_search(), InstrumentSearchParams (+8 more)
...
Cohesion: 0.16
Nodes (15): Bu(), e(), ko(), Lo(), No(), Nu(), or(), qr() (+7 more)
...
Cohesion: 0.08
Nodes (38): lookup_instrument_token(), resolve_token_blocking(), LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock() (+30 more)
...
Cohesion: 0.31
Nodes (10): init_consumer(), init_producer(), now_ms(), publish_insight(), publish_signal(), run(), now_ms(), parse_frame() (+2 more)
...
Cohesion: 0.12
Nodes (18): _a(), addItem(), Am(), Br(), _getName(), Gl(), It(), l (+10 more)
...
Cohesion: 0.03
Nodes (156): Ao(), apiKey(), applyPendingMigrations(), As(), Au(), Bc(), Bl(), bo() (+148 more)
...
Cohesion: 0.20
Nodes (16): analyze_sentiment_via_llm(), fetch_google_news_rss(), fetch_news_headlines(), fetch_symbol_sentiment(), first_non_empty(), LlmSentimentResponse, mock_sentiment(), resolve_llm_endpoint() (+8 more)
...
Cohesion: 0.01
Nodes (149): AggregateBrokerConnection, AggregateUser, BrokerConnection, BrokerConnectionAggregateArgs, BrokerConnectionArgs, BrokerConnectionCountAggregateInputType, BrokerConnectionCountAggregateOutputType, BrokerConnectionCountArgs (+141 more)
...
Cohesion: 0.01
Nodes (148): AggregateSubscription, AnyNull, At, AtBasic, AtLeast, AtLoose, AtStrict, BatchPayload (+140 more)
...
Cohesion: 0.13
Nodes (20): ARGON2_OPTIONS, hashPassword(), start, verifyPassword(), AuthenticationError, DuplicateEmailError, NotFoundError, PasswordComplexityError (+12 more)

### Community 174 - "Community 174"
Cohesion: 0.07
Nodes (33): AlphaPredictiveChart.tsx, DeepSeek v4 Pro via NVIDIA NIM, Technical Analysis Agent, DeepQuantPanel.tsx, TechSignal Protobuf Contract, LOADING_PHASES, LoadingStateProps, VerificationForm() (+25 more)
...
Cohesion: 0.07
Nodes (23): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, AuthOverlay(), BrokerConnectCard(), OAuthCompleteInner(), OAuthCompletePage() (+15 more)
...
Cohesion: 0.07
Nodes (42): ap(), cc(), ci(), en(), ep(), He(), highlight(), ic() (+34 more)
...
Cohesion: 0.12
Nodes (19): dm(), fromContent(), handleRequestError(), lineAt(), mapLines(), mapQueryEngineResult(), pm(), pp() (+11 more)
...
Cohesion: 0.12
Nodes (26): ac(), ea(), Fu(), hl(), ii(), lc(), Lu(), mapLineAt() (+18 more)

### Community 225 - "Community 225"
Cohesion: 0.15
Nodes (25): ACCESS_COOKIE_OPTS, COOKIE_OPTS, handleGenerateMfa(), handleGoogleLogin(), handleHealth(), handleLogin(), handleLogout(), handleRefresh() (+17 more)
...
Cohesion: 0.36
Nodes (8): alternativePaths, config, fs, path, Prisma, PrismaClient, {
...
Cohesion: 0.16
Nodes (5): PaymentController, paymentService, SubscriptionRepository, PaymentService, subscriptionRepository
...
Cohesion: 0.18
Nodes (4): AuthController, authService, controller, router

### Community 282 - "Community 282"
Cohesion: 0.38
Nodes (4): AuthenticatedRequest, authenticateJWT(), controller, router
...
Cohesion: 0.40
Nodes (3): app, token, userId

## Knowledge Gaps
- **1086 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1081 more)
...
- **Why does `run()` connect `Community 89` to `Community 225`, `Community 1`, `Community 7`, `Community 173`, `Community 50`, `Community 154`, `Community 27`, `Community 93`?**
