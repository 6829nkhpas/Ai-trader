...
## Corpus Check
- 165 files · ~89,206 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 567 nodes · 893 edges · 71 communities (61 shown, 10 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 102 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23a26bc5`
...
Cohesion: 0.08
Nodes (31): handleGenerateMfa(), handleGoogleLogin(), handleHealth(), handleLogin(), handleLogout(), handleRefresh(), handleRegister(), handleSession() (+23 more)
...
Cohesion: 0.2
Nodes (8): loadPrivateKey(), loadPublicKey(), verifyAccessToken(), authGuard(), blacklistJti(), isJtiBlacklisted(), registerTradeRoutes(), getRedisClient()

### Community 13 - "Community 13"
Cohesion: 0.26
Nodes (4): BillingController, findUserById(), registerBillingRoutes(), BillingService

### Community 14 - "Community 14"
Cohesion: 0.24
Nodes (10): aggregateCandles(), AlphaPredictiveChart(), calculateEMA(), fetchFromQuestDB(), fetchViaIpcProxy(), getQueries(), getQuestDbUrl(), isTauri() (+2 more)
...
- **Why does `main()` connect `Community 1` to `Community 3`, `Community 9`, `Community 11`, `Community 19`, `Community 21`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 6` to `Community 0`, `Community 10`, `Community 5`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `publish_tick()` connect `Community 9` to `Community 1`?**
