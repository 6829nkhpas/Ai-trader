...
## Corpus Check
- 203 files · ~217,599 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2534 nodes · 4385 edges · 219 communities (202 shown, 17 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 116 edges (avg confidence: 0.83)
...
- `AlphaPredictiveChartProps` --calls--> `useChartDataSync.ts Hook`  [EXTRACTED]
  frontend/src/utils/chartTypes.ts → COMPLETE_ANALYSIS.md
...
Cohesion: 0.06
Nodes (41): ConsensusEngine (Tauri Quant), Quant Radar Background Scanner, base_state(), candle(), compile_consensus_full_bullish(), compile_consensus_serializes_to_json(), ConsensusEngine, ConsensusReport (+33 more)
...
Cohesion: 0.07
Nodes (36): SystemConsole.tsx, StatusDot(), StatusLabel(), SystemConsole(), SystemLog, TradingChart(), TradingChartProps, AgentStatusPanel() (+28 more)
...
Cohesion: 0.11
Nodes (26): DrawingOverlays(), DrawingOverlaysProps, aggregateCandles(), AlphaPredictiveChart(), calculateEMA(), GhostLineToggle(), useChartDataSync(), FREEHAND_TOOLS (+18 more)
...
Cohesion: 0.13
Nodes (17): lookup_instrument_token(), resolve_token_blocking(), LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), LeftPanel() (+9 more)
...
Cohesion: 0.24
Nodes (16): useChartDataSync.ts Hook, MinimalCandle, ProjectedPoint, ProjectionPayload, useChartInit(), PredictiveSignal, aggregateCandles(), calculateEMA() (+8 more)
...
Cohesion: 0.20
Nodes (13): code:mermaid (graph TD), Core Data Flow & Orchestration, 🏗️ System Architecture & Data Flow, 1. High-Level Architecture Overview, 3. Core System Diagnostics & Error Isolation, 4. Architecture Specifications Reference, Alpha Suite — System Architecture & Feature-Wise Data Flows, code:mermaid (graph TB) (+5 more)

### Community 65 - "Community 65"
Cohesion: 0.08
Nodes (39): commands, commands, description, identifier, commands, description, identifier, commands (+31 more)
...
Cohesion: 0.19
Nodes (13): SentimentBlock(), SentimentBlockProps, sentimentImpactColor(), AgentTerminal(), DeepQuantPanel(), AiExecutionPlan, CompletedTrade, parseExecutionPlan() (+5 more)
...
Cohesion: 0.12
Nodes (16): description, identifier, commands, description, identifier, identifier, commands, description (+8 more)
...
Cohesion: 0.09
Nodes (16): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, OAuthCompleteInner(), OAuthCompletePage(), useAuth(), DashboardPage() (+8 more)
...
## Knowledge Gaps
- **820 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+815 more)
...
- **Why does `resolve_instrument_token()` connect `Community 9` to `Community 41`, `Community 27`, `Community 79`, `Community 47`?**
...
- **Why does `useHistoricalData.ts Hook` connect `Community 9` to `Community 44`, `Community 17`, `Community 19`, `Community 22`, `Community 57`?**
