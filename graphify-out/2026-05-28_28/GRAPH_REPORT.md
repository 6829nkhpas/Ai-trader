...
## Corpus Check
- 271 files · ~343,352 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5460 nodes · 12844 edges · 295 communities (272 shown, 23 thin omitted)
...
Cohesion: 0.05
Nodes (34): Home(), AuthOverlay(), BrokerConnectCard(), isSection(), ToolMenu(), ToolMenuEntry, ToolMenuProps, ToolOption (+26 more)
...
## Knowledge Gaps
- **1070 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1065 more)
