...
## Corpus Check
- 197 files · ~215,930 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2487 nodes · 4336 edges · 211 communities (194 shown, 17 thin omitted)
...
Cohesion: 0.21
Nodes (13): Alpha Suite V2 — Production Setup Guide, Architecture Reference, code:bash (cp .env.example .env), code:env (# ── Zerodha Kite Connect ──────────────────────────────────), code:bash (cd frontend), code:bash (cd frontend), Development Mode, Prerequisites (+5 more)
...
Cohesion: 0.05
Nodes (21): inter, metadata, AuthLayout(), handleEmailBlur(), handlePassBlur(), validateEmail(), validatePassword(), isSection() (+13 more)
...
Cohesion: 0.10
Nodes (27): get_api_key_from_vault(), AgentChoice, AgentMessage, AgentMessagePayload, AgentResponse, AgentToolCall, AppHandleExt, ChatChoice (+19 more)
...
Cohesion: 0.15
Nodes (13): authRoot, __dirname, loadPrivateKey(), loadPublicKey(), privateKeyPath, publicKeyPath, verifyAccessToken(), authGuard() (+5 more)
...
Cohesion: 0.22
Nodes (9): CMake Not Found (Local Dev Only), code:block10 (ERROR: Kite WS auth failed — 403 Forbidden), code:block11 (ERROR: DeepSeek API failure: NVIDIA NIM request timeout), code:block12 (error: failed to run custom build command for `rdkafka-sys`), code:block9 (ERROR: Alpha OHLC WS connection error → ws://127.0.0.1:8081), DeepSeek API Timeout, Kafka Connection Refused, KITE_ACCESS_TOKEN Expired (+1 more)
...
Cohesion: 0.31
Nodes (4): check_api_key_exists(), hydrate_key_cache(), save_api_key(), SecureKeyStore
...
Cohesion: 0.10
Nodes (17): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, OAuthCompleteInner(), OAuthCompletePage(), DashboardPage(), metadata (+9 more)
...
## Knowledge Gaps
- **788 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+783 more)
...
- **Why does `run()` connect `Community 93` to `Community 192`, `Community 1`, `Community 70`, `Community 7`, `Community 50`, `Community 89`, `Community 27`, `Community 157`?**
