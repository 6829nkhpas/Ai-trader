...
## Corpus Check
- 264 files · ~333,132 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5405 nodes · 12682 edges · 290 communities (272 shown, 18 thin omitted)
...
Cohesion: 0.05
Nodes (45): SystemConsole.tsx, StatusDot(), StatusLabel(), SystemConsole(), SystemLog, TradingChart(), TradingChartProps, AgentStatusPanel() (+37 more)
...
Cohesion: 0.06
Nodes (28): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, AuthOverlay(), handleEmailBlur(), handlePassBlur(), validateEmail() (+20 more)
...
## Knowledge Gaps
- **1107 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1102 more)
