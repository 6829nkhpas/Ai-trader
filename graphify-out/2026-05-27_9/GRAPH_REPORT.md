...
## Corpus Check
- 244 files · ~228,931 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2398 nodes · 4244 edges · 202 communities (184 shown, 18 thin omitted)
...
Cohesion: 0.09
Nodes (32): analyze_sentiment_via_llm(), fetch_google_news_rss(), fetch_news_headlines(), fetch_symbol_sentiment(), first_non_empty(), LlmSentimentResponse, mock_sentiment(), resolve_llm_endpoint() (+24 more)
...
Cohesion: 0.09
Nodes (34): LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock(), SentimentBlockProps, sentimentImpactColor() (+26 more)
...
Cohesion: 0.29
Nodes (7): BaseModel, Start or continue the Deep Quant LLM ReAct loop for a given thread_id., Rust tool server triggers this endpoint when the watched price and volume     co, resume_agent(), ResumeRequest, run_agent(), RunRequest
...
Cohesion: 0.15
Nodes (5): PROFILES, SecurityVault, TerminalLayoutProps, QuantRadar(), RadarAlert
...
- **Why does `resolve_instrument_token()` connect `Community 79` to `Community 41`, `Community 26`, `Community 27`, `Community 46`?**
...
- **Why does `run()` connect `Community 93` to `Community 1`, `Community 70`, `Community 7`, `Community 170`, `Community 16`, `Community 23`, `Community 27`, `Community 157`?**
