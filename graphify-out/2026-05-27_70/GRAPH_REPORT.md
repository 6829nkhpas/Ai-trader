...
## Corpus Check
- 252 files · ~323,759 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5328 nodes · 12564 edges · 289 communities (270 shown, 19 thin omitted)
...
Cohesion: 0.12
Nodes (11): current_count(), download_csv(), ensure_schema(), is_stale(), parse_and_persist(), parse_csv_line(), spawn(), run_consumer() (+3 more)
...
Cohesion: 0.11
Nodes (20): BILLING_CATALOG, handlePolarWebhook(), verifySignature(), handleKycVendorWebhook(), requireActiveSubscription(), requireVerified(), BillingRepository, registerTradeRoutes() (+12 more)
...
Cohesion: 0.25
Nodes (5): BillingController, registerBillingRoutes(), BillingService, body, prisma
...
Cohesion: 0.15
Nodes (19): handleGetProfile(), handleGetUploadUrl(), handleLivenessCheck(), handleUpsertProfile(), handleVerifyPan(), panBreaker, verifyPan(), mfaGuard() (+11 more)
...
Cohesion: 0.10
Nodes (33): ACCESS_COOKIE_OPTS, COOKIE_OPTS, handleGenerateMfa(), handleGoogleLogin(), handleHealth(), handleLogin(), handleLogout(), handleRefresh() (+25 more)
...
Cohesion: 0.24
Nodes (5): redis, BrokerRepository, brokerRepository, userRepository, prisma
...
## Knowledge Gaps
- **1083 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1078 more)
...
- **Why does `run()` connect `Community 50` to `Community 288`, `Community 1`, `Community 6`, `Community 7`, `Community 173`, `Community 154`, `Community 27`, `Community 93`?**
