...
## Corpus Check
- 201 files · ~217,003 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2529 nodes · 4377 edges · 216 communities (200 shown, 16 thin omitted)
...
Cohesion: 0.09
Nodes (28): TradingChart(), TradingChartProps, AgentStatusPanel(), AIPanel(), clampScore(), LiveFeedPanel(), PortfolioDashboard(), PortfolioDashboardProps (+20 more)
...
Cohesion: 0.16
Nodes (11): SentimentBlock(), SentimentBlockProps, sentimentImpactColor(), LeftPanel(), QuoteData, SearchInstrument, SECTOR_COLORS, SentimentBlock() (+3 more)

### Community 48 - "Community 48"
Cohesion: 0.17
Nodes (15): Glass-Box Trading Frontend, MacroSentimentPanel, MarketInsight Protobuf, OrderBook.tsx Level-2 DOM, ProfileSwitcher.tsx, Quant-RAG Agent (DeepSeek), Kafka Topic: signals.insights, SwingConfluencePanel (+7 more)
...
Cohesion: 0.19
Nodes (5): OAuthCompleteInner(), useAuth(), resolvePostAuthDestination(), LoginPage(), SignupPage()
...
Cohesion: 0.33
Nodes (4): prisma, app, token, userId
...
Cohesion: 0.09
Nodes (20): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, SystemConsole.tsx, OAuthCompletePage(), StatusDot(), StatusLabel() (+12 more)
...
Cohesion: 0.46
Nodes (7): LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), LiveAssetHUD(), ConsensusReport
...
## Knowledge Gaps
- **819 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+814 more)
...
- **Why does `useHistoricalData.ts Hook` connect `Community 79` to `Community 17`, `Community 19`, `Community 44`, `Community 22`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 93` to `Community 192`, `Community 1`, `Community 6`, `Community 70`, `Community 7`, `Community 14`, `Community 89`, `Community 27`, `Community 157`?**
