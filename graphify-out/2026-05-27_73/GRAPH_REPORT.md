...
## Corpus Check
- 258 files · ~323,607 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5349 nodes · 12594 edges · 293 communities (276 shown, 17 thin omitted)
...
## Communities (293 total, 17 thin omitted)
...
Cohesion: 0.10
Nodes (24): registerErrorHandler(), registerStocksRoutes(), getClient(), isArticleProcessed(), markArticleProcessed(), getClient(), scoreArticle(), closePool() (+16 more)
...
Cohesion: 0.15
Nodes (13): handleKycVendorWebhook(), requireActiveSubscription(), requireVerified(), updateKycStatus(), registerTradeRoutes(), registerWebhookRoutes(), futureDate, mockReply (+5 more)
...
Cohesion: 0.09
Nodes (40): DrawingOverlays(), DrawingOverlaysProps, useChartDataSync.ts Hook, aggregateCandles(), AlphaPredictiveChart(), calculateEMA(), GhostLineToggle(), MinimalCandle (+32 more)
...
Cohesion: 0.07
Nodes (28): app, deepLink, security, windows, build, beforeBuildCommand, beforeDevCommand, devUrl (+20 more)
...
Cohesion: 0.13
Nodes (15): DeepSeek v4 Pro via NVIDIA NIM, DeepQuantPanel.tsx, LOADING_PHASES, LoadingStateProps, VerificationForm(), VerificationFormProps, convictionIcon(), convictionLabel() (+7 more)
...
Cohesion: 0.08
Nodes (42): LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock(), SentimentBlockProps, sentimentImpactColor() (+34 more)
...
Cohesion: 0.09
Nodes (36): ACCESS_COOKIE_OPTS, COOKIE_OPTS, handleGenerateMfa(), handleGoogleLogin(), handleHealth(), handleLogin(), handleLogout(), handleRefresh() (+28 more)
...
Cohesion: 0.07
Nodes (24): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, AuthOverlay(), BrokerConnectCard(), OAuthCompleteInner(), OAuthCompletePage() (+16 more)
...
Cohesion: 0.11
Nodes (9): redis, BrokerRepository, UserRepository, brokerRepository, userRepository, prisma, app, token (+1 more)
...
Cohesion: 0.14
Nodes (3): AuthController, authService, AuthService

### Community 282 - "Community 282"
Cohesion: 0.27
Nodes (6): AuthenticatedRequest, authenticateJWT(), controller, router, controller, router
