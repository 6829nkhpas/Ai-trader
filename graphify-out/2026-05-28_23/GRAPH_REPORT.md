...
## Corpus Check
- 269 files · ~342,010 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5447 nodes · 12830 edges · 292 communities (271 shown, 21 thin omitted)
...
## Communities (292 total, 21 thin omitted)
...
Cohesion: 0.09
Nodes (15): fetch_candles_for_symbol(), RadarAlert, spawn_radar_worker(), current_count(), download_csv(), ensure_schema(), is_stale(), parse_and_persist() (+7 more)
...
Cohesion: 0.10
Nodes (23): registerErrorHandler(), registerAuthRoutes(), registerStocksRoutes(), getClient(), isArticleProcessed(), markArticleProcessed(), getClient(), scoreArticle() (+15 more)
...
Cohesion: 0.06
Nodes (37): SystemConsole.tsx, StatusDot(), StatusLabel(), SystemConsole(), SystemLog, TradingChart(), TradingChartProps, AgentStatusPanel() (+29 more)
...
Cohesion: 0.12
Nodes (22): handleGetProfile(), handleGetUploadUrl(), handleLivenessCheck(), handleUpsertProfile(), handleVerifyPan(), handleKycVendorWebhook(), panBreaker, verifyPan() (+14 more)
...
Cohesion: 0.07
Nodes (39): lookup_instrument_token(), resolve_token_blocking(), LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock() (+31 more)
...
Cohesion: 0.17
Nodes (22): ACCESS_COOKIE_OPTS, COOKIE_OPTS, handleGenerateMfa(), handleGoogleLogin(), handleHealth(), handleLogin(), handleLogout(), handleRefresh() (+14 more)
...
Cohesion: 0.11
Nodes (15): BillingController, authRoot, __dirname, loadPrivateKey(), loadPublicKey(), privateKeyPath, publicKeyPath, verifyAccessToken() (+7 more)
...
Cohesion: 0.29
Nodes (5): init_producer(), KafkaProducer, publish_candle(), publish_signal(), publish_tick()
...
Cohesion: 0.09
Nodes (22): AuthOverlay(), BrokerConnectCard(), TerminalDashboard(), MarginData, OrderItem, PositionItem, PositionsPayload, useMargins() (+14 more)
...
Cohesion: 0.10
Nodes (22): DeepSeek v4 Pro via NVIDIA NIM, DeepQuantPanel.tsx, AiExecutionPlanView(), AiExecutionPlanViewProps, AiPlanShape, convictionColor(), convictionIcon(), convictionLabel() (+14 more)
...
Cohesion: 0.07
Nodes (21): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, OAuthCompleteInner(), OAuthCompletePage(), useAuth(), DashboardPage() (+13 more)
...
## Knowledge Gaps
- **1062 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1057 more)
