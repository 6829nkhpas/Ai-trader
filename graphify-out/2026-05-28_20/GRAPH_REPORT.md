...
## Corpus Check
- 267 files · ~340,194 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5437 nodes · 12809 edges · 293 communities (272 shown, 21 thin omitted)
...
## Communities (293 total, 21 thin omitted)
...
Cohesion: 0.10
Nodes (16): fetch_candles_for_symbol(), RadarAlert, spawn_radar_worker(), current_count(), download_csv(), ensure_schema(), is_stale(), parse_and_persist() (+8 more)
...
Cohesion: 0.09
Nodes (24): registerErrorHandler(), registerStocksRoutes(), BillingSyncEngine, getClient(), isArticleProcessed(), markArticleProcessed(), getClient(), scoreArticle() (+16 more)
...
Cohesion: 0.06
Nodes (41): SystemConsole.tsx, StatusDot(), StatusLabel(), SystemConsole(), SystemLog, TradingChart(), TradingChartProps, IntradayLayout() (+33 more)
...
Cohesion: 0.11
Nodes (26): handleGetProfile(), handleGetUploadUrl(), handleLivenessCheck(), handleUpsertProfile(), handleVerifyPan(), handleKycVendorWebhook(), decryptSymmetric(), encryptSymmetric() (+18 more)
...
Cohesion: 0.18
Nodes (20): ACCESS_COOKIE_OPTS, COOKIE_OPTS, handleGenerateMfa(), handleGoogleLogin(), handleHealth(), handleLogin(), handleLogout(), handleRefresh() (+12 more)
...
Cohesion: 0.07
Nodes (45): LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock(), SentimentBlockProps, sentimentImpactColor() (+37 more)
...
Cohesion: 0.10
Nodes (11): SqlTrade, UserProfileModal(), UserProfileModalProps, BrokerTab(), BrokerTabProps, maskValue(), PortfolioTabProps, ProfileTabProps (+3 more)
...
Cohesion: 0.06
Nodes (27): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, AuthOverlay(), handleEmailBlur(), handlePassBlur(), validateEmail() (+19 more)
...
## Knowledge Gaps
- **1058 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1053 more)
...
- **Why does `run()` connect `Community 50` to `Community 1`, `Community 7`, `Community 173`, `Community 89`, `Community 154`, `Community 27`, `Community 93`?**
