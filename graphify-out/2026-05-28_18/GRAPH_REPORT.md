...
## Corpus Check
- 265 files · ~339,363 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5425 nodes · 12781 edges · 292 communities (274 shown, 18 thin omitted)
...
## Communities (292 total, 18 thin omitted)
...
Cohesion: 0.08
Nodes (19): rsi_warm_up_gating(), update_rsi(), update_vwap(), vwap_basic_calculation(), vwap_no_volume_returns_none(), generate_access_token(), KiteSessionData, KiteSessionResponse (+11 more)
...
Cohesion: 0.07
Nodes (37): Alpha Suite V2 — Production Setup Guide, Architecture Reference, CMake Not Found (Local Dev Only), code:bash (cp .env.example .env), code:block10 (ERROR: Kite WS auth failed — 403 Forbidden), code:block11 (ERROR: DeepSeek API failure: NVIDIA NIM request timeout), code:block12 (error: failed to run custom build command for `rdkafka-sys`), code:env (# ── Zerodha Kite Connect ──────────────────────────────────) (+29 more)
...
Cohesion: 0.06
Nodes (48): lookup_instrument_token(), resolve_token_blocking(), LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock() (+40 more)
...
Cohesion: 0.12
Nodes (10): SqlTrade, UserProfileModal(), UserProfileModalProps, BrokerTab(), BrokerTabProps, maskValue(), ProfileTabProps, SubscriptionTabProps (+2 more)
...
Cohesion: 0.11
Nodes (20): DeepSeek v4 Pro via NVIDIA NIM, DeepQuantPanel.tsx, AiExecutionPlanView(), AiExecutionPlanViewProps, AiPlanShape, convictionColor(), convictionIcon(), convictionLabel() (+12 more)
...
## Knowledge Gaps
- **1055 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1050 more)
...
- **Why does `run()` connect `Community 50` to `Community 1`, `Community 6`, `Community 7`, `Community 43`, `Community 189`, `Community 154`, `Community 27`, `Community 93`?**
