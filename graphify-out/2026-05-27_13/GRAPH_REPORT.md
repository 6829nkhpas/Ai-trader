...
## Corpus Check
- 244 files · ~229,594 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2403 nodes · 4251 edges · 200 communities (182 shown, 18 thin omitted)
...
Cohesion: 0.10
Nodes (31): analyze_sentiment_via_llm(), fetch_google_news_rss(), fetch_news_headlines(), fetch_symbol_sentiment(), first_non_empty(), LlmSentimentResponse, mock_sentiment(), resolve_llm_endpoint() (+23 more)
...
Cohesion: 0.08
Nodes (30): TradingChart(), TradingChartProps, AgentStatusPanel(), AIPanel(), clampScore(), LiveFeedPanel(), AgentTerminal(), DeepQuantPanel() (+22 more)
