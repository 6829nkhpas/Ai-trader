...
## Corpus Check
- 244 files · ~230,223 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2404 nodes · 4252 edges · 214 communities (193 shown, 21 thin omitted)
...
Cohesion: 0.09
Nodes (30): LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock(), SentimentBlockProps, sentimentImpactColor() (+22 more)
...
- **Why does `useHistoricalData.ts Hook` connect `Community 22` to `Community 48`, `Community 17`?**
