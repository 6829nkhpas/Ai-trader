...
## Corpus Check
- 243 files · ~322,586 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5287 nodes · 12504 edges · 284 communities (269 shown, 15 thin omitted)
...
Cohesion: 0.18
Nodes (11): fetch_candles_for_symbol(), RadarAlert, spawn_radar_worker(), current_count(), download_csv(), ensure_schema(), is_stale(), parse_and_persist() (+3 more)
...
Cohesion: 0.11
Nodes (18): BILLING_CATALOG, BillingController, handlePolarWebhook(), verifySignature(), requireActiveSubscription(), requireVerified(), BillingRepository, BillingService (+10 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (26): registerErrorHandler(), registerAuthRoutes(), registerStocksRoutes(), registerTradeRoutes(), BillingSyncEngine, getClient(), isArticleProcessed(), markArticleProcessed() (+18 more)
...
Cohesion: 0.49
Nodes (6): confidence_is_clamped(), flat_prices_yield_high_confidence(), PredictionEngine, returns_none_when_window_incomplete(), returns_prediction_at_full_window(), window_never_exceeds_capacity()
...
Cohesion: 0.60
Nodes (3): AuthOverlay(), AuthState, useAuthStore
