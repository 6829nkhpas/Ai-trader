...
## Corpus Check
- 254 files · ~324,164 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5338 nodes · 12578 edges · 286 communities (269 shown, 17 thin omitted)
...
Cohesion: 0.15
Nodes (5): redis, BrokerRepository, UserRepository, brokerRepository, userRepository
...
Cohesion: 0.13
Nodes (9): AuthController, authService, authenticateJWT(), next, AuthenticatedRequest, authenticateJWT(), controller, router (+1 more)
...
## Knowledge Gaps
- **1084 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1079 more)
