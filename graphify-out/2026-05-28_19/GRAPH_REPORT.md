...
## Corpus Check
- 266 files · ~340,114 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5434 nodes · 12802 edges · 295 communities (276 shown, 19 thin omitted)
...
Cohesion: 0.13
Nodes (27): aggregateToTimeframe(), calculateEMA(), calculateRSI(), computeTrend(), generateSyntheticOhlc(), TIMEFRAME_CONFIGS, TimeframeTrend, TrendBias (+19 more)
...
Cohesion: 0.12
Nodes (20): lookup_instrument_token(), resolve_token_blocking(), fetchInstruments(), GET(), GET(), get_kite_credentials(), historical_handler(), HistoricalParams (+12 more)
...
Cohesion: 0.05
Nodes (26): AuthOverlay(), BrokerConnectCard(), isSection(), ToolMenu(), ToolMenuEntry, ToolMenuProps, ToolOption, ToolSection (+18 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (46): Home(), LiveAssetHUD(), LiveAssetHUDProps, stateColor(), trendBg(), trendColor(), SentimentBlock(), SentimentBlockProps (+38 more)
...
Cohesion: 0.24
Nodes (4): paymentService, SubscriptionRepository, PaymentService, subscriptionRepository
...
Cohesion: 0.12
Nodes (10): BrokerRepository, UserRepository, brokerRepository, userRepository, prisma, app, AuthenticatedRequest, currentPeriodEnd (+2 more)

### Community 279 - "Community 279"
Cohesion: 0.15
Nodes (9): AuthenticatedRequest, base64Payload, calculatedSha256, decodedJson, PhonePeController, phonepePayload, router, sha256 (+1 more)
...
Cohesion: 0.22
Nodes (6): PaymentController, AuthenticatedRequest, authenticateJWT(), controller, phonePeController, router
...
Cohesion: 0.23
Nodes (3): redis, kiteService, PortfolioController
...
## Knowledge Gaps
- **1056 isolated node(s):** `name`, `version`, `private`, `test:rust`, `test:e2e` (+1051 more)
