...
## Corpus Check
- 244 files · ~232,593 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2427 nodes · 4277 edges · 198 communities (182 shown, 16 thin omitted)
...
Cohesion: 0.22
Nodes (9): current_count(), download_csv(), ensure_schema(), is_stale(), parse_and_persist(), parse_csv_line(), spawn(), run_consumer() (+1 more)
...
Cohesion: 0.11
Nodes (18): BILLING_CATALOG, handlePolarWebhook(), verifySignature(), handleKycVendorWebhook(), requireActiveSubscription(), requireVerified(), BillingRepository, updateKycStatus() (+10 more)

### Community 7 - "Community 7"
Cohesion: 0.13
Nodes (20): analyzeSentiment(), getClient(), getClient(), isArticleProcessed(), markArticleProcessed(), getClient(), scoreArticle(), DEFAULT_PAGE_SIZE (+12 more)
...
Cohesion: 0.13
Nodes (11): registerErrorHandler(), registerStocksRoutes(), BillingSyncEngine, config, __dirname, required, closePool(), app (+3 more)
...
Cohesion: 0.27
Nodes (12): decryptSymmetric(), encryptSymmetric(), getKey(), activateMfaRecord(), findMfaRecord(), upsertMfaRecord(), decryptProfileData(), encryptProfileData() (+4 more)
...
Cohesion: 0.06
Nodes (59): AlphaPredictiveChart.tsx, Technical Analysis Agent, DrawingOverlays(), DrawingOverlaysProps, useChartDataSync.ts Hook, aggregateCandles(), AlphaPredictiveChart(), calculateEMA() (+51 more)
...
Cohesion: 0.25
Nodes (10): handleGetProfile(), handleGetUploadUrl(), handleLivenessCheck(), handleUpsertProfile(), handleVerifyPan(), verifyPan(), mfaGuard(), registerKycRoutes() (+2 more)
...
Cohesion: 0.08
Nodes (31): DeepSeek v4 Pro via NVIDIA NIM, ConsensusEngine (Tauri Quant), DeepQuantPanel.tsx, Quant Radar Background Scanner, AiExecutionPlanView(), AiExecutionPlanViewProps, AiPlanShape, convictionColor() (+23 more)
...
Cohesion: 0.33
Nodes (7): init_consumer(), init_producer(), now_ms(), publish_insight(), publish_signal(), run(), run_listener()
...
Cohesion: 0.29
Nodes (9): run_instrument_sync(), now_ms(), parse_frame(), parse_packet(), run(), is_test_mode(), mock_ai_execution_plan(), mock_ohlc_tick() (+1 more)
...
Cohesion: 0.07
Nodes (24): gate(), Home(), SIDEBAR_CONFIG, SidebarTab, SystemConsole.tsx, OAuthCompleteInner(), OAuthCompletePage(), StatusDot() (+16 more)
...
- **Why does `run()` connect `Community 93` to `Community 1`, `Community 70`, `Community 7`, `Community 9`, `Community 48`, `Community 86`, `Community 89`, `Community 27`, `Community 157`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `useHistoricalData.ts Hook` connect `Community 79` to `Community 62`, `Community 17`, `Community 44`, `Community 22`?**
