  ...
  return (
    <div className="space-y-5 flex flex-col h-full">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-extrabold text-text-primary tracking-tight">Order Book</h2>
          <p className="text-xs text-text-secondary mt-1">Live client orders and execution records</p>
        </div>
      </div>

      {error && (
        <div className="flex items-center gap-2 rounded-none border border-rose-500/30 bg-rose-500/5 p-3 text-xs text-rose-400">
          <AlertCircle size={14} />
          <span>{error}</span>
        </div>
      )}
                ...
                return (
                  <React.Fragment key={order.order_id || idx}>
                    ...
                    >
                      ...
                      <td className="px-4 py-2.5 text-right font-mono text-text-primary">{order.quantity}</td>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-[11px] animate-in fade-in slide-in-from-top-1 duration-150">
                              ...
                              <div className="border border-border-default/30 rounded-none bg-muted/50 p-3.5 space-y-2">
                                ...
                                <div className="flex justify-between">
                                  ...
                                  <span className="font-mono text-text-primary font-semibold truncate max-w-[140px]" title={order.exchange_order_id}>
